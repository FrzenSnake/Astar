// TypeScript file
class Grid{
private var_starNode:any;
private var_endNode:any;
private var_nodes:Array<buildnode>[];
public var_numCols=10;
public var_numRows=10;
public mapsize=100;
private config=[];
private stage:any;
...
public getNode(x:number,y:number):buildnode
{
    var result:buildnode=this.config[y*this.var_numRows + x].node;
    return result;
}
}
